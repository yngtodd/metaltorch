...
struct CAFFE2_API TypeExtendedInterface : public Type {
  ...
  virtual std::tuple<Tensor &,Tensor &> _thnn_adaptive_max_pool2d_forward_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const = 0;
  virtual std::tuple<Tensor,Tensor> _thnn_adaptive_max_pool2d_forward(const Tensor & self, IntArrayRef output_size) const = 0;
  ...
  virtual std::tuple<Tensor &,Tensor &> _thnn_adaptive_max_pool3d_forward_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const = 0;
  virtual std::tuple<Tensor,Tensor> _thnn_adaptive_max_pool3d_forward(const Tensor & self, IntArrayRef output_size) const = 0;
  ...
  virtual Tensor logspace(Scalar start, Scalar end, int64_t steps, const TensorOptions & options) const = 0;
  virtual Tensor & logspace_out(Tensor & out, Scalar start, Scalar end, int64_t steps) const = 0;
  ...
  virtual Tensor & native_pow_out(Tensor & out, const Tensor & self, Scalar exponent) const = 0;
  ...
  virtual Tensor & cross_out(Tensor & out, const Tensor & self, const Tensor & other, int64_t dim) const = 0;
  ...
  virtual Tensor & potri_out(Tensor & out, const Tensor & self, bool upper) const = 0;
  ...
  virtual Tensor & btrisolve_out(Tensor & out, const Tensor & self, const Tensor & LU_data, const Tensor & LU_pivots) const = 0;
  ...
  virtual std::tuple<Tensor &,Tensor &> adaptive_max_pool2d_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const = 0;
  ...
  virtual std::tuple<Tensor &,Tensor &> adaptive_max_pool3d_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const = 0;
