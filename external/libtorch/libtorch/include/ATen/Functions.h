...
static inline Tensor & native_pow_out(Tensor & out, const Tensor & self, Scalar exponent);
...
static inline Tensor & cross_out(Tensor & out, const Tensor & self, const Tensor & other, int64_t dim=-1);
...
static inline Tensor & btrisolve_out(Tensor & out, const Tensor & self, const Tensor & LU_data, const Tensor & LU_pivots);
...
static inline Tensor & native_pow_out(Tensor & out, const Tensor & self, Scalar exponent) {
    return detail::infer_type(self).native_pow_out(out, self, exponent);
}
static inline Tensor native_pow(const Tensor & self, Scalar exponent) {
...
static inline Tensor & cross_out(Tensor & out, const Tensor & self, const Tensor & other, int64_t dim) {
...
static inline Tensor & btrisolve_out(Tensor & out, const Tensor & self, const Tensor & LU_data, const Tensor & LU_pivots) {
    return detail::infer_type(self).btrisolve_out(out, self, LU_data, LU_pivots);
}
static inline Tensor btrisolve(const Tensor & self, const Tensor & LU_data, const Tensor & LU_pivots) {
